...
public class AESUtils {
	...
	public static final String INVITING_SECRET_KEY = "inviting_secret_key_szcq_cxm_old_belt_new";

	/**
	 * <p>
	 * Discription:[加密]
	 * </p>
	 * Created on 2018年07月17日
	 * 
	 * @param content
	 *            明文 用JSON.toJSONString(Map<String, String> map)转换的json字符串
	 * @param key
	 *            加解密规则 访客系统提供key
	 * @return String 密文
	 * @author:[全冉]
